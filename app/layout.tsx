...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: 'Zawsze jesteśmy Obok Ciebie żeby pomóc :) Działamy tylko dzięki wsparciu naszych darczyńców. Dołączaj do nas, z nami jest fajnie :)',
    ...
    keywords: ['Fundacja Obok Ciebie', 'Fundacja Charytatywna', 'Platforma Fundraisingowa'],
    authors: [{ name: 'Ivan Shyriaiev', url: 'https://ivan-shyriaiev-website.vercel.app/'}],
