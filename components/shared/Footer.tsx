	...
	return (
		...
		>
			...
			<div className='w-full items-center flex flex-col justify-center'>
				...
				<p className='text-[0.75rem] text-myGray text-center w-full'>Website made by: <Link className='text-purple-300 hover:underline' href='https://code-by-ivan.xyz' target='_blank'>code-by-ivan</Link></p>
			</div>
		</footer>
	)
}
